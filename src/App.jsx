  ...
  return (
    <section id="home" className="relative min-h-screen pt-36 pb-28 flex items-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img src="/hero-bg.png" alt="Abstract glowing background" className="w-full h-full object-cover opacity-30" />
...
export default function App() {
  useEffect(() => {
    ...
    link.rel = 'icon'
    link.type = 'image/png'
    link.href = '/tab-logo.png?v=' + Date.now()
